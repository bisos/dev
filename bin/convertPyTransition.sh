...
$( examplesSeperatorSection "Cleanups After Conversion" )
find . -type f -print | egrep '.py.3$|.py.2to3$|.py.tabs$|.py.bak$'
find . -type f -print | egrep '.py.3$|.py.2to3$|.py.tabs$|.py.bak$' | xargs rm # ALERT
